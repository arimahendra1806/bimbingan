        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Konsultasi Program</h5>
                ...
                <form id="FormAdd">
                    ...
                    <div class="modal-body">
                        <div class="row mb-1">
                            <div class="col-md-12">
                                <label for="link_video_add" class="col-form-label">Link Video Konsultasi: <b
                                        class="error">*Pastikan berupa link youtube</b></label>
                                <input type="text" class="form-control" id="link_video_add" name="link_video_add">
                                <span class="text-danger error-text link_video_add_error"></span>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
            ...
            <div class="modal-content">
                ...
                <form id="FormEdit">
                    ...
                    <div class="modal-body">
                        <div class="row mb-1">
                            <div class="col-md-12">
                                <label for="link_video_edit" class="col-form-label">Link Video Konsultasi: <b
                                        class="error">*Pastikan berupa link youtube</b></label>
                                <input type="text" class="form-control" id="link_video_edit" name="link_video_edit">
                                <span class="text-danger error-text link_video_edit_error"></span>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-md-12">
                        ...
                        <div class="collapse show" id="collapseCetak">
                            <div class="card-body" style="text-align: justify">
                                @if ($detail['status_konsultasi'] == 'Disetujui')
                                    <p>
                                        Konsultasi program sudah disetujui untuk pengujian, silahkan lengkapi pengerjaan
                                        Laporan Akhir.<u><a href="{{ route('bimbingan-laporan.index') }}">Konsultasi
                                                Laporan</a></u>.
                                    </p>
                                @elseif ($detail['status_konsultasi'] == 'Selesai')
                                    <p>
                                        Selamat konsultasi program Anda sudah selesai.
                                    </p>
                                @endif
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">
                            Silahkan upload link video konsultasi program Anda.
                        </p>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            var tableRiwayat = $('#RiwayatTabels').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('bimbingan-program.riwayat') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.get('konsultasi-program/show/' + this_id, function(data) {
                    $('#ModalEdit').modal('show');
                    $('#id_edit').val(data.id);
                    $('#link_video_edit').val(data.bimbingan.link_video);
            ...
            $("#FormEdit").submit(function(e) {
                ...
                $.ajax({
                    url: "konsultasi-program/" + this_id,
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
