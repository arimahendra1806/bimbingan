        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Data Pengumuman Anda</h5>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Pengumuman untuk <b>Anda</b></h4>
                                <p class="card-title-desc">
                                    Anda dapat melihat pengumuman online dari Ketua Prodi, Koordinator, maupun Dosen.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var roleTable = $('#RoleTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('pengumuman.roleInfo') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('body').on('click', '#btnDetail', function() {
                ...
                $.get('pengumuman/role/info/' + this_id, function(data) {
                    ...
                    tDetail.ajax.url("/pengumuman-show/" + data.informasi.id).load();
                }).then(function() {
                    loaderNotif();
