        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Pengumpulan Laporan TA</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Pengumpulan Laporan TA</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Pengumpulan Laporan TA</h4>
                        <p class="card-title-desc">
                            Setelah Anda melakukan <b>pengujian</b> dan <b>sudah melakukan revisi</b>, segera upload
                            <b>lembar pengumpulan laporan TA</b> yang mengetahui Pihak Perpustakaan, Pihak Prodi
    ...
    <script>
        $(document).ready(function() {
            ...
            $(function() {
                ...
                if (y != '0') {
                    $('#fileView').attr('src', 'dokumen/pengumpulan/laporan/' + y);
                    $('#fileView').show();
                }
            });
            ...
            $("#FormAdd").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('pengumpulan-laporan.storeLap') }}",
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
                    ...
                    success: function(data) {
                        if (data.status == 0) {
                            ...
                            $('#status_upload').text(data.resp.status + " | " + data.resp
                                .keterangan);
                            $('#fileView').attr('src', '/dokumen/pengumpulan/laporan/' + data
                                .resp
                                .nama_file);
                            $('#status_upload').show();
                            $('#fileView').show();
