        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Verifikasi Lembar Pengumpulan Laporan TA</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Verifikasi Lembar Pengumpulan Laporan TA</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Verifikasi Lembar Pengumpulan Laporan TA</h4>
                        <p class="card-title-desc">
                            Segera verifikasi lembar pengumpulan laporan TA dari masing-masing Mahasiswa.
                        </p>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#Tabels').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('pengumpulan-laporan.indexAdmLap') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('#status').on('select2:select', function(e) {
                ...
                if (y == "Sudah Divalidasi") {
                    $('#keterangan').val('Admin Prodi sudah memvalidasi lembar pengumpulan laporan Anda.');
                } else if (y == "Tidak Diterima") {
                    $('#keterangan').val(
                        'Admin Prodi tidak menerima lembar pengumpulan laporan Anda. Silahkan upload kembali!'
                    );
                }
            });
