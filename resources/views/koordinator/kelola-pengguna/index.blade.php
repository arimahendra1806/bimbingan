            ...
            <div class="modal-content">
                ...
                <form id="PenggunaFormAdd">
                    ...
                    <div class="modal-body">
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <label for="nama_pengguna_add" class="col-form-label">Nama Pengguna: <b
                                        class="error">*Pastikan Pilih Nama Pengguna</b></label>
                        ...
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <label for="role_pengguna_add" class="col-form-label">Role Pengguna: <b
                                        class="error">*Pastikan Pilih Role Pengguna</b></label>
                                <select class="js-example-responsive form-control" style="width: 100%"
                        ...
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <label for="identitas_id_add" class="col-form-label">Identitas Id: <b
                                        class="info">*Otomatis Terisi Jika Nama Pengguna Dipilih</b></label>
                                <input type="text" class="form-control" id="identitas_id_add" name="identitas_id_add"
                                    placeholder="*e.g: NIDN/NIM">
                            </div>
                            <div class="col-md-6">
                                <label for="email_pengguna_add" class="col-form-label">Email Pengguna: <b
                                        class="info">*Otomatis Terisi Jika Nama Pengguna Dipilih</b></label>
                                <input type="email" class="form-control" id="email_pengguna_add" name="email_pengguna_add"
                                    placeholder="*e.g: NIDN/NIM@bimbingan.id">
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="PenggunaFormEdit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <label for="identitas_id_edit" class="col-form-label">Identitas Id: <b
                                        class="info">*Otomatis Terisi Jika Nama Pengguna Dipilih</b></label>
                                <input type="text" class="form-control" id="identitas_id_edit" name="identitas_id_edit"
                                    placeholder="NIDN/NIM">
                            </div>
                            <div class="col-md-6">
                                <label for="email_pengguna_edit" class="col-form-label">Email Pengguna: <b
                                        class="info">*Otomatis Terisi Jika Nama Pengguna Dipilih</b></label>
                                <input type="email" class="form-control" id="email_pengguna_edit"
                                    name="email_pengguna_edit" placeholder="NIDN/NIM@bimbingan.id">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="row mb-1">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control no-outline" id="identitas_id_show"
                                name="identitas_id_show" readonly>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-1">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control no-outline" id="email_pengguna_show"
                                name="email_pengguna_show" readonly>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
