        ...
        <div class="modal-content">
            ...
            <form id="TahunAjaranFormAdd">
                ...
                <div class="modal-body">
                    <div class="mb-1">
                        <label for="tahun_ajaran_add" class="col-form-label">Tahun Ajaran: <b class="error">*Pastikan Tahun Ajaran Terisi</b></label>
                        <input type="text" class="form-control" id="tahun_ajaran_add" name="tahun_ajaran_add" placeholder="e.g: 2019/2020">
                    </div>
                    <div class="mb-1">
                        <label for="tahun_status_add" class="col-form-label">Status: <b class="error">*Pastikan Pilih Status</b></label>
                        <select class="js-example-responsive form-control" style="width: 100%" id="tahun_status_add" name="tahun_status_add">
                            <option value=""></option>
            ...
            <form id="TahunAjaranFormEdit">
                ...
                <div class="modal-body">
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control" id="tahun_ajaran_edit" name="tahun_ajaran_edit" placeholder="YYYY/YYYY">
                    </div>
                    <div class="mb-1">
                        <label for="tahun_status_edit" class="col-form-label">Status:</label>
                        <select class="js-example-responsive form-control" style="width: 100%" id="tahun_status_edit" name="tahun_status_edit">
                            <option value=""></option>
                            <option value="Aktif">Aktif</option>
                            <option value="Tidak Aktif">Tidak Aktif</option>
                        </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control no-outline" id="tahun_ajaran_show" name="tahun_ajaran_show" readonly>
                </div>
                <div class="mb-1">
                    <label for="tahun_status_show" class="col-form-label">Status:</label>
                    <input type="text" class="form-control no-outline" id="tahun_status_show" name="tahun_status_show" readonly>
                </div>
            </div>
            <div class="modal-footer">
