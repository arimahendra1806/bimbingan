        ...
        <div class="modal-content">
            ...
            <form id="MhsFormAdd">
                ...
                <div class="modal-body">
                    <div class="row mb-1">
                        <div class="col-md-6">
                            <label for="nim_add" class="col-form-label">NIM: <b class="error">*Pastikan NIM Terisi</b></label>
                            <input type="text" class="form-control" id="nim_add" name="nim_add" placeholder="e.g: 19XXXXXXXXX">
                        </div>
                        <div class="col-md-6">
                            <label for="nama_mhs_add" class="col-form-label">Nama Mahasiswa: <b class="error">*Pastikan Nama Mahasiswa Terisi</b></label>
                            <input type="text" class="form-control" id="nama_mhs_add" name="nama_mhs_add" placeholder="e.g: Jailudin">
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-md-6">
                            <label for="email_add" class="col-form-label">Email: <b class="error">*Pastikan Email Terisi</b></label>
                            <input type="text" class="form-control" id="email_add" name="email_add" placeholder="e.g: Jailudin@gmail.com">
                        </div>
                        <div class="col-md-6">
                            <label for="no_telepon_add" class="col-form-label">Nomor Telepon: <b class="error">*Pastikan Terisi | Tanpa 0 | Terhubung Whatsapp</b></label>
                            <div class="input-group">
                                <div class="input-group-text">+62</div>
                                <input type="text" class="form-control" id="no_telepon_add" name="no_telepon_add" placeholder="e.g: 81XXXXXXXX">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
                    ...
                    <div class="row mb-1">
                        <div class="col-md-12">
                            <label for="alamat_add" class="col-form-label">Alamat: <b class="error">*Pastikan Alamat Terisi</b></label><br>
                            <textarea class="form-control" name="alamat_add" id="alamat_add" style="width: 100%" rows="3"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-1">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="alamat_edit" id="alamat_edit" style="width: 100%" rows="3"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-body">
                <div class="row mb-1">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control no-outline" id="nama_mhs_show" name="nama_mhs_show" readonly>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control no-outline" id="no_telepon_show" name="no_telepon_show" readonly>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-12">
        ...
        $("#ImportForm").submit(function(e){
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    table.ajax.reload();
                    Swal.fire({
                        title: "Import Data Mahasiswa Berhasil!",
                        icon: "success",
                    }).then(function(){
