...
@section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Perbarui Data Konsultasi Proposal</h5>
                ...
                <form id="FormEdit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-1">
                            <div class="col-md-12">
                                ...
                                <select class="js-example-responsive form-control" style="width: 100%" id="progres"
                                    ...
                                    <option value="proposal_bab1">Bab 1</option>
                                    <option value="proposal_bab2">Bab 2</option>
                                    <option value="proposal_bab3">Bab 3</option>
                                    <option value="proposal_bab4">Bab 4</option>
                                </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="status_cek">
                                        Centang jika ingin konsultasi berstatus "selesai tahap revisi pengujian"
                                    </label>
                                </div>
                            </div>
                        </div><br>
                        <p style="font-size: 9pt">
                            note : <br>
                            jika ingin konsultasi berstatus "siap untuk diuji", pastikan keempat bab sudah terpilih!<br>
                            jika ingin konsultasi berstatus "selesai tahap revisi pengujian", pastikan keempat bab sudah
                            terpilih dan pastikan opsi tercentang!
                        </p>
                    </div>
    ...
    <div class="modal fade" id="ModalShow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Data Konsultasi Proposal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-1">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Peninjauan Konsultasi Proposal</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Peninjauan Konsultasi Proposal</li>
                        </ol>
                    </div>
            ...
            <div class="col-8">
                <div class="card" style="min-height: 200px">
                    <div class="card-header">
                        <h4 class="card-title">Peninjauan Konsultasi Proposal</h4>
                    ...
                    <div class="card-body">
                        <div class="text-center" id="pertama">
                            <h5>Silahkan pilih nama <b>Mahasiswa</b> pada <b>daftar konsultasi Proposal</b> untuk
            ...
            <div class="col-4">
                <div class="card" style="min-height: 200px">
                    <div class="container mt-4">
                        <h4 class="card-title">Daftar Konsultasi Proposal</h4>
                        <p class="card-title-desc">
    ...
    <script>
        $(document).ready(function() {
            ...
            function detail(kode) {
                $.get('peninjauan-konsultasi-proposal/' + kode, function(data) {
            ...
            var table = $('#Tabels').DataTable({
                processing: false,
                serverSide: true,
                ajax: "{{ route('peninjauan-proposal.index') }}",
                columns: [{
            ...
            var tableRiwayat = $('#RiwayatTabels').DataTable({
                processing: true,
                serverSide: true,
                ajax: 'peninjauan-konsultasi-proposal/riwayat/0',
                autoWidth: false,
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
            ...
            var tableKomen = $('#KomenTabels').DataTable({
                processing: true,
                serverSide: true,
                ajax: 'peninjauan-konsultasi-proposal/komen/0',
                columns: [{
                    name: 'komentar'
                }, ],
                columnDefs: [{
            ...
            $('#Tabels tbody').on('click', 'tr', function() {
                ...
                if (!has) {
                    ...
                    detail(this_id);
                    tableKomen.ajax.url("peninjauan-konsultasi-proposal/komen/" + this_id).load();
                    tableRiwayat.ajax.url("peninjauan-konsultasi-proposal/riwayat/" + this_id).load();
                    kedua();
                } else {
            ...
            $('body').on('click', '#btnShow', function() {
                ...
                $.get('peninjauan-konsultasi-proposal/show/' + this_id, function(data) {
                    ...
                    $('#keterangan_show').val(data.data.keterangan);
                    $('#tanggapan_show').val(data.data.tanggapan);
                });
            });
            ...
            $("#FormEdit").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('peninjauan-proposal.store') }}",
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
            ...
            $("#KomenStore").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('peninjauan-proposal.storeKomen') }}",
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
