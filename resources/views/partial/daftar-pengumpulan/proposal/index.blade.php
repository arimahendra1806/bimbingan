        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Daftar Pengumpulan Proposal TA dari Mahasiswa</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Daftar Pengumpulan Proposal TA dari Mahasiswa</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Daftar Pengumpulan Proposal TA dari Mahasiswa</h4>
                        <p class="card-title-desc">
                            Berikut adalah daftar mahasiswa yang sudah mengumpulkan proposal TA.
                        </p>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#Tabels').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar-proposal.daftarPro') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
