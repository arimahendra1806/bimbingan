                        ...
                        <div class="card-header bg-transparent border-success">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 d-flex justify-content-end">
                                    <a class="d-block text-success btn-lg"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @elseif(Auth::check() && Auth::user()->role == 'admin')
                            <p class="card-title-desc">
                                Anda dapat mengelola pengumuman online kepada semua Mahasiswa.
                            </p>
                        @endif
                    </div>
                    <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.get('kelola-pengumuman/' + this_id, function(data) {
                    ...
                    if (data.data.kepada_role == "semua pengguna" || data.data.kepada_role ==
                        ...
                        $("#kepada_edit").empty();
                        $.get('kelola-pengumuman/kepada/' + data.data.kepada_role, function(data) {
                        ...
                        $.get('kelola-pengumuman/kepada/' + data.data.kepada_role, function(data) {
                            ...
                            $('#kepada_edit').val(data.selectNm).trigger('change');
                        });
                    }
                    ...
                    tEdit.ajax.url("/kelola-pengumuman-edit/" + this_id).load();
                });
            });
            ...
            $('body').on('click', '#btnShow', function() {
                ...
                $.get('kelola-pengumuman/' + this_id, function(data) {
                    ...
                    tShow.ajax.url("/kelola-pengumuman-show/" + this_id).load();
                });
            });
            ...
            $('body').on('click', '#btnDetail', function() {
                ...
                $.get('kelola-pengumuman/role/info/' + this_id, function(data) {
                    ...
                    tDetail.ajax.url("/kelola-pengumuman-show/" + data.informasi.id).load();
                }).then(function() {
                    loaderNotif();
